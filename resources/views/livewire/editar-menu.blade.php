<form wire:submit.prevent="submit" class="space-y-5 md:w-1/2" novalidate>
    ...
    <div>
        <div class="my-5 w-80">
            ...
            <img src="{{ asset('storage/imagenes-ajustadas/'.$imagen)}}" alt="{{'Imagen vacante ' }}">
        </div>
        
        <div class="my-5 w-80">
            <x-input-label for="imagen" :value="__('Sube una nueva imagen')" />
    ...
    <div>
        <x-primary-button class="justify-center w-full py-3 text-base font-black bg-emerald-600 hover:text-black hover:bg-emerald-700">Guardar Cambios</x-primary-button>
    </div>
</form>
